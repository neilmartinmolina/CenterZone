...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
  <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between">
      <div><p class="text-sm font-medium text-slate-500">Total Projects</p>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between">
      <div><p class="text-sm font-medium text-slate-500">Subjects</p>
...
<tr class="border-b border-slate-50 hover:bg-slate-50 transition-colors">
  ...
  <td class="py-3 pr-4"><span class="px-2 py-1 rounded bg-blue-50 text-blue-700 text-sm font-medium"><?php echo htmlspecialchars($r["current_version"]); ?></span></td>
  <td class="py-3 pr-4 text-slate-600"><?php echo htmlspecialchars(displayUpdatedBy($r)); ?></td>
  <td class="py-3 pr-4 text-slate-500 text-sm"><?php echo htmlspecialchars(formatNucleusDateTime($r["last_updated_at"])); ?></td>
</tr>
<?php endforeach; ?>
</tbody>
    </table>
